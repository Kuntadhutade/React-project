...
export const DetailsPage = () => {
  ...
  useEffect(() => {
    const fetchMovieDetails = async () => {
      try {
        const res = await fetch(
          `https://api.themoviedb.org/3/movie/${id}?api_key=ac6ccd4964b9f8e5953099e2a8f50fc9&language=en-US`
    ...
    const handleVideos = async() => {
      try {
        const res = await fetch(
          `https://api.themoviedb.org/3/movie/${id}/videos?api_key=ac6ccd4964b9f8e5953099e2a8f50fc9&language=en-US`
      ...
      >
       <DialogContent>
        <Box>
          <iframe 
            title="Trailer"
            src={`https://www.youtube.com/embed/${videos?.results[5]?.key}`}
            style={{
               width: "100%",
               height: "100%"
            }}
